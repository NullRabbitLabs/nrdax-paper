...
Every URL below was checked on 2026-07-24. Figures quoted in this paper are computed from the pinned snapshot taken that day, at registry version **v0.2**. The registry is increment-only, so a live read will show a larger total than the paper states.
